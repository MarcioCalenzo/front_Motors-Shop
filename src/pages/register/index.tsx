      ...
      <main className="w-full flex justify-center items-center bg-grey8">
        <div className="bg-grey10 w-[34.625rem] rounded mt-[2.875rem] mb-[2.875rem]">
          <form
            ...
            className="w-full h-full py-11 px-12 flex justify-center items-center"
            noValidate
          >
            <fieldset className="w-full flex flex-col">
              ...
              <label className="text-sm text-grey1 font-medium mb-6">CPF</label>
              <input
                {...register("cpf")}
                type="text"
              ...
              <label className="text-sm text-grey1 font-medium mb-6">CEP</label>
              <input
                {...register("cep")}
                type="text"
              ...
              <label className="text-sm text-grey1 font-medium mb-6">Rua</label>
              <input
                {...register("street")}
                type="text"
              ...
              <button
                type="submit"
                className="h-[3rem] bg-brand1 rounded font-semibold text-whiteFixed"
              >
                Finalizar cadastro
              </button>
            </fieldset>
