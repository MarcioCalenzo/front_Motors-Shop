  ...
  return (
    <li className="w-[16rem] h-[25.875rem]">
      <div className="card-product-img bg-grey7 h-[9.5rem] mb-4">
        <img
          src={car_product}
          alt="Imagem do carro vinculado ao anúncio."
          className="max-h-[9.5rem]"
        ></img>
      </div>
      ...
      <div className="card-product-info_user mb-4 flex items-center">
        ...
        <span className="text-sm text-grey2 font-normal">Fulano de tal</span>
      </div>
      ...
      <div className="flex">
        <button
          type="button"
          className="h-[2.375rem] flex items-center justify-center border-2 border-grey1 py-3 px-5 mr-4 rounded"
        >
          Editar
        </button>
        <Link
          to={"/product"}
          className="h-[2.375rem] flex items-center justify-center border-2 border-grey1 py-3 px-5 rounded"
        >
          Ver detalhes
        </Link>
      </div>
